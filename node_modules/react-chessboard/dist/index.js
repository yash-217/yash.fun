...
const DndMonitorContext = React.createContext(null);
...
const InternalContext = React.createContext(defaultInternalContext);
const PublicContext = React.createContext(defaultPublicContext);
...
const ActiveDraggableContext = React.createContext({ ...defaultCoordinates,
  scaleX: 1,
  scaleY: 1
});
var Status;
...
const DndContext = React.memo(function DndContext(_ref) {
...
const PositionedOverlay = React.forwardRef((_ref, ref) => {
  let {
    as,
    activatorEvent,
    adjustScale,
