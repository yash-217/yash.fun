...
function pawnPromotesAtSquares(oldPosition, newPosition, oldSquare, newSquare, noOfRows, noOfColumns) {
  ...
  const promotablePieces = /* @__PURE__ */ new Set(["Q", "R", "B", "N"]);
  let pawnSquare;
  let promotionSquare;
  ...
  const columnDifference = Math.abs(chessColumnToColumnIndex(pawnSquare[0], noOfColumns, "black") - chessColumnToColumnIndex(promotionSquare[0], noOfColumns, "black"));
  ...
  if (oldPiece[0] === "b" && pawnSquareRowIndex === 1 && promotionSquareRowIndex === 0) {
    return true;
  } else if (oldPiece[0] === "w" && pawnSquareRowIndex === noOfRows - 2 && promotionSquareRowIndex === noOfRows - 1) {
    return true;
  } else {
    return false;
  }
...
function ChessboardProvider({ children, options }) {
  ...
  return (0, import_jsx_runtime.jsx)(ChessboardContext.Provider, { value: {
    ...
    drawArrow,
    clearArrows
  }, children: (0, import_jsx_runtime.jsx)(DndContext, { autoScroll: allowAutoScroll, collisionDetection, onDragStart: handleDragStart, onDragEnd: handleDragEnd, onDragCancel: handleDragCancel, sensors, id: dndId, children }) });
}
function Arrows() {
...
var Square = (0, import_react.memo)(function Square2({ children, squareId, isLightSquare, isOver }) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { id: `${id}-square-${squareId}`, style: {
    ...
    if (e.buttons === 2 && allowDrawingArrows && newArrowStartSquare && newArrowStartSquare !== squareId) {
